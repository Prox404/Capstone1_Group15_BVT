...
public class CommentAdapter extends RecyclerView.Adapter<CommentAdapter.CommentViewHolder> {
    ...
    public CommentAdapter(List<Comment> comments, DatabaseReference commentReference, String post_id) {
    ...
    public void onBindViewHolder(@NonNull CommentViewHolder holder, int position) {
        ...
        if(comment.getReplies() != null && comment.getReplies().size() > 0){
            ...
            CommentAdapter replyAdapter = new CommentAdapter(replyList, commentReference.child(comment.getComment_id()).child("replies"), post_id);
        ...
        holder.imageEditComment.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(comment.getUser().getUser_id().equals(user_id)){
            ...
            public boolean onMenuItemClick(MenuItem menuItem) {
                ...
                if (id == R.id.itemdeletepost) {
                    ...
                    DatabaseReference reference_delete = FirebaseDatabase.getInstance()
                            .getReference("posts").child(post_id);
