...
public class CertificateAdapter extends RecyclerView.Adapter<CertificateAdapter.ViewHolder> {
    ...
    public CertificateAdapter(Context context, List<Vaccination_Registration> vaccinationRegistions) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        String imageUrl = registration.getVaccine().getVaccine_image().get(0);
