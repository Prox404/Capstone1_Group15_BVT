package com.vaccinecenter.babyvaccinationtracker.service;
...
import com.vaccinecenter.babyvaccinationtracker.NotificationActivity;
...
public class NotificationService extends Service {
    ...
    private String notificationChannelId = "VaccineNotificationCenter";
    ...
    public void onCreate() {
        ...
        Log.i("NotificationService", "onCreate: " + user_id);
...
//        notificationIds = new Gson().fromJson(notificationPreferences.getString("notificationIds", ""), new TypeToken<ArrayList<String>>(){}.getType());
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel channel = new NotificationChannel(notificationChannelId, "VaccineNotificationCenter", NotificationManager.IMPORTANCE_DEFAULT);
        ...
        query.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                ...
                Log.i("Notification_service", "onChildAdded: " + object.toString());
                ...
                if (notificationMessage != null && notificationMessage.getDate().after(new Date()) ) {
