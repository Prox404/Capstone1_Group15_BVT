...
public class view_child_information extends AppCompatActivity {
    ...
    ImageView imageView_Back, imageView_Baby_Avatar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            baby = (Baby) bundle.getSerializable("baby_name");
            if (baby != null) {
        ...
        imageView_Back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(view_child_information.this, children_data_management.class);
